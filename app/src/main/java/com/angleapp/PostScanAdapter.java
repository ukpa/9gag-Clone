...
/**
 * Created by unnikrishnanpatel on 08/05/16.
 */
 ...
 */
public class PostScanAdapter extends RecyclerView.Adapter<PostScanAdapter.ViewHolder> {
    private PaginatedScanList<Post> mDataset;
    ...
    public PostScanAdapter(PaginatedScanList<Post> myDataset, Context c) {
        mDataset = myDataset;
        context = c;
    ...
    @Override
    public PostScanAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                     int viewType) {
        // create a new view
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if(mDataset.get(position).getVotes().contains(Application.userId)){
            holder.cardUpVote.setImageDrawable(PostScanAdapter.this.context.getResources().getDrawable(R.mipmap.heart));
        }
        ...
        holder.cardUpVote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!votes.contains(Application.userId)){
                    ...
                    holder.cardUpVote.setImageDrawable(PostScanAdapter.this.context.getResources().getDrawable(R.mipmap.heart_outline));
                    holder.votePost.setText(String.valueOf(votes.size()-1));
                    mDataset.get(position).setVotes(votes);
                    AsyncTask<Void,Void,Void> asyncTask = new AsyncTask<Void, Void, Void>() {
                        @Override
